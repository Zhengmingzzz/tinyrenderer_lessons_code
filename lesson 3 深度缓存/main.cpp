...
int main(int argc, char** argv) {
	if (2 == argc) {
		...
		model = new Model("E:\\tiny_renderer_dir\\tinyrenderer\\tinyrenderer_lessons_code\\lesson 3 Éî¶È»º´æ\\obj\\african_head\\african_head.obj");
	}
	...
	for (int i = 0; i < model->nfaces(); i++) {
		...
		if (intensity <= 0)
			continue;
		//triangle(pts, zbuffer, image, TGAColor(255 , 255 , 255 , 255));
